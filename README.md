...
* Configured architectures are:
  * [linux-x64](https://hub.docker.com/r/dockcross/linux-x64), **x86_64** for regular desktop (does not require cross, uses glibc 2.36)
  * [linux-armv6](https://hub.docker.com/r/dockcross/linux-armv6), arm-linux-gnueabihf, armhf, glibc 2.34
  ...
  * [linux-armv7](https://hub.docker.com/r/dockcross/linux-armv7), **armv7** for e.g. Raspberry Pi with glibc 2.34
  * [linux-armv7-lts](https://hub.docker.com/r/dockcross/linux-armv7-lts), **armv7** for e.g. Raspberry Pi with glibc 2.28
  * [linux-arm64](https://hub.docker.com/r/dockcross/linux-arm64), **arm64** for e.g. Yocto Linux
  * [linux-arm64-lts](https://hub.docker.com/r/dockcross/linux-arm64-lts), **arm64**
